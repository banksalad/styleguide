...
* 프로젝트의 초기 세팅에 [cookiecutter](https://github.com/audreyr/cookiecutter)와 [banksalad/python](https://github.com/banksalad/python) 템플릿을 사용합니다.
